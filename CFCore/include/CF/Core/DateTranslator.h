...
/*
    ...
    Contains:   Efficient routines & data structures for converting from
                RFC 1123 compliant date strings to local file system
                dates & vice versa.

*/

#ifndef __CF_DATE_TRANSLATOR_H__
#define __CF_DATE_TRANSLATOR_H__
...
class DateBuffer {
 public:
  ...
  void Update(const SInt64 &inDate) {
    DateTranslator::UpdateDateBuffer(this, inDate);
  }
